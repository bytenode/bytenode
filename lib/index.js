...
const Bytenode = {
   ...
   * @param {boolean} createLoader Whether to create loader file along side
   * the compiled file. Defaults to false.
   ...
   * deliberatly to `null`, the bytecode buffer will be returned
   * instead.
   */
  compile ({
    code,
    ...
    assert(code != null || filename != null,
      new Error('Either code or filename is required.'));

    assert(code == null || typeof code === 'string',
