...
class JavaScriptEntity {
   ...
   * @param {string} filename The path to the JavaScript file. This file will
   * be used in stack traces produced by this script. Also, if `code` is not
   * specified, `filename` will be compiled instead.
...
const Bytenode = {
   ...
   * @param {string} filename The path to the JavaScript file. This file will
   * be used in stack traces produced by this script. If `code` is not
   * specified, `filename` will be compiled instead.
   * @param {boolean} [compileAsModule=true] whether to compile `code` or
   * `filename` as a CommonJs module. Defaults to true.
